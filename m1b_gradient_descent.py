...
def gradient_descent(x, y, learning_rate, number_of_iterations):
    ...
    for i in range(number_of_iterations):
        ...
        if( i % 100 == 0):     
            ...
            print("iteracion", i, " Estimación actual:", model.get_summary(), f"Costo: {cost}")

            if (cost + 0.001) >= last_cost:
                print("Entrenamiento del modelo completo después",i, "iteraciones")
                break
            last_cost = cost

    if i == (number_of_iterations - 1):
        print("Número máximo de iteraciones alcanzado. Dejar de entrenar")
